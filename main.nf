...
workflow run_tasks{
    /*
        This workflow will generate the completed PSMs for the tasks specified in params.input_file.
...
workflow get_tasks_from_file{
    /*
        This workflow will extract all unique tasks from the massiveKB metadata file, with the file location specified in the input_file parameter.
    */
